...
type PublicationDocumentData = Record<string, never>;
/**
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PublicationDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<Simplify<PublicationDocumentData>, "publication", Lang>;
...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { PostDocumentData, PostDocumentDataSlicesSlice, PostDocument, PublicationDocumentData, PublicationDocument, AllDocumentTypes };
    }
}
